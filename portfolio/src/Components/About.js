...
function Home(props) {
    return (
        ...
        <h2>Doth a fox proclaim its foxitude? <br/>(or why I have emoji of a fox and a hedgehog on my homepage)</h2>
